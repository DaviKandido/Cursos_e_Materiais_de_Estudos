    ...
    <nav className="flex justify-between items-center ">
      <div className="flex flex-row justify-around items-center w-full">
        ...
        <div className="flex items-center w-[364px] h-[48px] ml-[8px] bg-[var(--background-card-gray)] rounded-[500px] border-solid border-[#b3b3b300] border-[1px]">
          ...
          <input id="search-input" type="text" placeholder="O que voce quer ouvir..." maxLength={800} className="bg-transparent pr-[100px] pl-[12px] text-ellipsis text-[#fff] overflow-hidden whitespace-nowrap outline-none"/>
        </div>
